  ...
  useEffect(() => {
    fetch('/noticias.json')
      ...
      .then(data => {
        ...
        const noticiasCategoria1 = data.noticiastecnologia;
        ...
        const noticiasCategoria2 = data.noticiastecnologia;
        ...
        const noticiasCategoria3 = data.noticiastecnologia;
        ...
        const noticiasCategoria4 = data.noticiastecnologia;
