...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    fetch('/noticias.json')
      ...
      .then(data => {
        const noticiasCategoria = data['noticiasComportamento '];
      ...
      {noticiaPrincipal ? (
        <div className='ml-[20px] mr-[20px]'>
          <div className='grid grid-cols-12 gap-4 mt-[150px] mb-[20px]'>
            <h1 className='text-roxo-p08 grid col-start-2 col-span-3 text-[20px] font-black text-4xl'>Comportamento</h1>
          </div>
          <div className='grid grid-cols-12 gap-4'>
            {/* Renderiza a notícia principal */}
