...
const Footer = () => {
    return (
        <footer className="bottom-0 left-0 w-full bg-gray-250 flex flex-col md:flex-row text-black text-sm md:text-base lg:text-lg xl:text-xl justify-center items-center space-y-1 md:space-y-0">
