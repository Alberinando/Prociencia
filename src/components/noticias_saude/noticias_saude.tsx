  ...
  useEffect(() => {
    fetch('/noticias.json')
      ...
      .then(data => {
        ...
        const noticiasCategoria2 = data.noticiasSaude;
        ...
        const noticiasCategoria3 = data.noticiasSaude;
        ...
        const noticiasCategoria4 = data.noticiasSaude;
      ...
      {noticiaPrincipal ? (
        <div className=''>
          ...
          <div className='md:flex flex-row  md:grid grid-cols-12 gap-4 '>
            ...
            <div className='grid col-start-2 col-span-3 mr-[20px] ml-[20px] mb-[40px]'>
              {noticiaCategoria1 && (
            ...
            <div className='grid col-start-5 col-span-4 ml-[20px] mr-[20px]'>
              {noticiaCategoria2 && (
