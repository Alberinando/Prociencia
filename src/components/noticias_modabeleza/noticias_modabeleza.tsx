  ...
  useEffect(() => {
    fetch('/noticias.json')
      ...
      .then(data => {
        ...
        const noticiasCategoria1 = data.noticiasModaEBeleza;
        const randomIndexCategoria1 = Math.floor(Math.random() * noticiasCategoria1.length);
        setNoticiaCategoria1(noticiasCategoria1[randomIndexCategoria1]);

        const noticiasCategoria2 = data.noticiasModaEBeleza;
        const randomIndexCategoria2 = Math.floor(Math.random() * noticiasCategoria2.length);
        setNoticiaCategoria2(noticiasCategoria2[randomIndexCategoria2]);

        const noticiasCategoria3 = data.noticiasModaEBeleza;
        const randomIndexCategoria3 = Math.floor(Math.random() * noticiasCategoria3.length);
        setNoticiaCategoria3(noticiasCategoria3[randomIndexCategoria3]);

        const noticiasCategoria4 = data.noticiasModaEBeleza;
        const randomIndexCategoria4 = Math.floor(Math.random() * noticiasCategoria4.length);
        setNoticiaCategoria4(noticiasCategoria4[randomIndexCategoria4]);
      })
      ...
      {noticiaPrincipal ? (
        <div className='ml-[20px] mr-[20px]'>
          <div className='grid grid-cols-12 gap-4 mt-[150px] mb-[20px]'>
            <h1 className='text-roxo-p08 grid col-start-2 col-span-8 text-[20px] font-black text-4xl'>Moda e Beleza</h1>
          </div>
          <div className='md:flex flex-row  md:grid grid-cols-12 gap-4  '>
            ...
            <div className='grid col-start-5 col-span-4'>
              {noticiaCategoria2 && (
            ...
            <div className="grid col-start-10 col-span-2 hidden md:block">
                <div className='bg-roxo-p08  rounded border order border-roxo-p08 mb-4'>
                ...
                <a href={formatLink(noticiaCategoria2.LinkNoticia)} rel="noopener noreferrer">
                    <div className='flex flex-row mb-4'>
                        ...
                        <img src={noticiaCategoria2.LinkImagen} alt={noticiaCategoria2.titulo} className='w-16 h-16 mr-2' />
            

                        <h1 className='text-base  font-black text-[12px]'>{noticiaCategoria2.titulo}</h1>
          ...
          <div className='grid grid-cols-12 gap-4 mt-[20px]'>
            <a href="/ConjuntoDeNoticias/CienciaPage" rel="noopener noreferrer" className="text-roxo-p08 grid col-start-2 col-span-8 font-black ">
                <div className=' flex flex-row'>
