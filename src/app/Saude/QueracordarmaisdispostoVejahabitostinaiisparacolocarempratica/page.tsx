...
export default function noticia() {
    return (
        <>
           <h1>Quer acordar mais disposto? Veja hábitos matinais para colocar em prática</h1>
           <h2>Especialistas dão dicas de cardápio matinal e rotina de autocuidados que vão ajudá-lo a ter mais foco e produtividade durante o dia</h2>
