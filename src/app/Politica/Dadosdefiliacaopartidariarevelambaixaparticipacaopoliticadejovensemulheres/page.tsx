...
export default function noticia() {
    return (
        <>
           <h1>Dados de filiação partidária revelam baixa participação política de jovens e mulheres</h1>
           <p>
                Um ano após as Eleições 2022, número de filiados entre 16 e 24 anos caiu 14%. Maioria do eleitorado, mulheres 
