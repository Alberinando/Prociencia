...
export default function noticia() {
    return (
        <>
           <h1>Mês da Mulher: veja leis que asseguram direito das mulheres e como recorrer</h1>
           <h2>Leis combatem discriminação e violência contra mulheres em diversas categorias, como doméstica, sexual e política.</h2>
